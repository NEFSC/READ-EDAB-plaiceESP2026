...
From ESP: "Bottom temperature anomaly is a significant factor influencing depth of occurrence, with plaice shifting deeper and a more northward distribution with increasing bottom temperature. Mean latitude has gradually shifted northward since the late 1990s and bottom temperature anomaly
...
March-August bottom temperature anomaly affects recruitment. Much of the 2010s were warmer than the long term mean, with seasonal highs greater than 8C and reaching 9C in 2020, higher than the optimal spawning temperatures. The last few years have been around or below the long term mean, which may be beneficial for plaice recruitment.
...
Annual bottom temp anomaly leading up to fall survey (Sept-August) affects mean latitude and fall condition. There is a long-term increasing trend in annual bottom temperatures (Oct-Sept) since 1970, with highs above the long-term mean throughout much of the 2010s and early 2020s. Annual mean temperatures prior to the fall survey since 2023, however, have declined from recent highs and are near the long-term mean. An overall warming trend in bottom temperatures may be contributing to the northward shift in plaice distribution and changes in fish condition.
```{r, eval = file.exists(url1) & file.exists(url2), results='asis'}
#| fig-width: 7
#| fig-align: center
...
Sea surface temperature is an important consideration for plaice recruitment and egg and larval survival. The thermal limit for survival and incubation of American plaice eggs is 14C.
...
***
March-June SST anomaly affects plaice recruitment. Spring temperatures have hovered around 7-8C since the early 1980s, however temperatures in more recent years are exceeding the long-term mean. Seasonal temperatures have declined since 2022, which may be beneficial for plaice recruitment.
```{r}
#| fig-width: 7
#| fig-align: center
...
From ESP: "GSI was a significant driver of recruitment in the fall. GSI explained more deviance in weight-at-age trends at younger ages and tended to exhibite a positive relationship on WAA."

#### ANNUAL MEAN GULF STREAM POSITION PRIOR TO FALL SURVEY = OCT(year-1) - SEPT
The annual mean of the Gulf Stream position leading up to fall survey affects recruitment. There is an overall long-term increasing trend in the position of the Gulf Stream since 1970, with the Gulf Stream being further north than the long-term mean in recent years. The Gulf Stream has been at or above the long-term mean since 2020, which may be contributing to warmer water temperatures in the Gulf of Maine and affecting plaice recruitment.
```{r}
gsi <- ecodata::gsi |>
...
From ESP: "Reproductive rate (recruits per spawner) of American plaice is significantly related to temperature and the North Atlantic Oscillation, where greatest recruitment rates occur at extreme cold temperatures. NAO has a significant affect on depth of occurrence in the fall."


#### NAO 2 YEAR LAG
The North Atlantic Oscillation (NAO)  index is a measure of the strength and position of the westerly winds across the North Atlantic. Strong positive phases of the NAO tend to be associated with above-normal temperatures in the eastern United States. The NAO index 1-2 year lag effect on American plaice recruitment. The NAO index (lagged 2 years) has remained near the long-term mean throughout much of the time series (since 1970), with a few years of extreme negative NAO values early 2010s and extreme positive NAO values in 2020.
```{r}
...
6 months AMO prior to spring survey (Sept-Feb) affects recruitment. There is a long-term increasing trend in the AMO index (Apr-Sept), with recent peaks in the 2023 and 2024. The AMO index has been above the long-term mean since 2020, which may be contributing to higher recruitment.
```{r}
